...
class Student extends User{
    constructor(username, email, password, first_name, middle_name, last_name, age, gender, major, semester){
        super(username, email, password, first_name, middle_name, last_name, age, gender);
